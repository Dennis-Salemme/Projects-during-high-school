...
void apprendimento(int pedina, struct giocatore giocatore1, struct giocatore giocatore2, int nummossapedina, int numes, int totmosse,
                   ...
                   int *sommadiff, int *sommadiffpedone, int *sommadifftorre, int *sommadiffcavallo, int *sommadiffalfiere, int *sommadiffregina, int *sommadiffre);
...
/*cnt1=1;
    ...
    int contacicli;
    int numes, numespedone, numestorre, numescavallo, numesalfiere, numesregina, numesre;
    int sommadiff, sommadiffpedone, sommadifftorre, sommadiffcavallo, sommadiffalfiere, sommadiffregina, sommadiffre;

    promozionigioc1=0;
    promozionigioc2=0;
    totmosse=1;
    finegioco=0;
    numes=0; numespedone=0; numestorre=0; numescavallo=0; numesalfiere=0; numesregina=0; numesre=0;
    sommadiff=0; sommadiffpedone=0; sommadifftorre=0; sommadiffcavallo=0; sommadiffalfiere=0; sommadiffregina=0; sommadiffre=0;
    srand(time(NULL));
...
do
{
    ...
    if(finegioco==0)
    {
        ...
        apprendimento(oscurapedone, giocatore1, giocatore2, sceltamossarand, numes, totmosse, numespedone, numestorre, numescavallo, numesalfiere, numesregina, numesre,
                      &sommadiff, &sommadiffpedone, &sommadifftorre, &sommadiffcavallo, &sommadiffalfiere, &sommadiffregina, &sommadiffre);
